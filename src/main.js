...
class App{
    ...
    registerHandlers(){
        this.formEl.onsubmit = event => this.addReposity(event);
    }
    ...
    async addReposity(event){
        ...
        try{
            ...
            const {name, login, bio, html_url, avatar_url} = response.data;

            this.repositories.push({
                name: name === null ? login : name,
                bio: bio === null ? 'Sem descrição' : bio,
                avatar_url,
                html_url
            });
